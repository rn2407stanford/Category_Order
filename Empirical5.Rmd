...
for ( i in 1:nrow(d)){
  if (d[i,1]>0 & d[i,2]>0) {
    f=0.3*mean(as.numeric(d[i,]))
  }
  else{ f=0.3*mean(as.numeric(d[i,which(d[i,]<0)]))}
  d08=rbind(d08, f)
}
```
...
```{r}
empirical5=list(Index1=data.frame(z1), Index2=df1., Index3=df1b, Index4=data.frame(s4[,7]), Index5=d08, Index6=d09)
saveRDS(empirical5, file="C:/Users/Roza/Desktop/Order.12.15.23/Data/empirical5.RData")
```
