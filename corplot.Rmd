...
cor1=corrplot(round(cor(empirical1[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")] ), 1 ), method="circle", addCoef.col = 'black', title="Learning Emotions", mar=c(0,0,1,0))
cor2=corrplot(round(cor(empirical2[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="Loneliness", mar=c(0,0,1,0)) 
cor3=corrplot(round(cor(empirical3[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black',  title="Wilpat", mar=c(0,0,1,0))
cor4=corrplot(round(cor(empirical4[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="Youth Depression", mar=c(0,0,1,0))
cor5=corrplot(round(cor(empirical5[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="CEAQ", mar=c(0,0,1,0))
...
png(height=300, width=300, file="cor1.png", type = "cairo")
cor1=corrplot(round(cor(empirical1[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")] ), 1 ), method="circle", addCoef.col = 'black', title="Learning Emotions", mar=c(0,0,1,0))
dev.off()

png(height=300, width=300, file="cor2.png", type = "cairo")
cor2=corrplot(round(cor(empirical2[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="Loneliness", mar=c(0,0,1,0)) 
dev.off()

png(height=300, width=300, file="cor3.png", type = "cairo")
cor3=corrplot(round(cor(empirical3[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="WilPat", mar=c(0,0,1,0))
dev.off()

png(height=300, width=300, file="cor4.png", type = "cairo")
cor4=corrplot(round(cor(empirical4[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="CDI", mar=c(0,0,1,0))
dev.off()

png(height=300, width=300, file="cor5.png", type = "cairo")
cor5=corrplot(round(cor(empirical5[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="CEAQ", mar=c(0,0,1,0))
dev.off()

png(height=300, width=300, file="corall.png", type = "cairo")
corall=corrplot(round(cor(all[,c("Index1", "Index2", "Index3", "Index4", "Index5", "Index6")]), 1 ), method="circle", addCoef.col = 'black', title="all", mar=c(0,0,1,0))
dev.off()
```
