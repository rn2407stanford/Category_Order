...
```{r}
empirical3=list(Index1=data.frame(z1), Index2=df1., Index3=df1b, Index4=data.frame(s4[,7]), Index5=d08, Index6=d09)
saveRDS(empirical3, file="C:/Users/Roza/Desktop/Order.12.15.23/Data/empirical3.RData")
```
